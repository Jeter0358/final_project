...
public class DrinkList extends AppCompatActivity {
    ...
    String[] foodNameArray = new String[]{"草莓蛋糕","巧克力蛋糕","波霸珍珠奶茶","拿鐵"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_AddFood.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast toast=Toast.makeText(DrinkList.this,"餐點已加入購物車!",
                        Toast.LENGTH_SHORT);
                toast.show();
            ...
            public void onItemClick(AdapterView<?>parent,View v,
                ...
                switch (position){
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        textView1.setText("餐點名稱:波霸珍珠奶茶\n餐點價格:70元");
                        num=0;
                        tv_num.setText(" "+num);
                        image=2;
                        break;
                    case 3:
                        textView1.setText("餐點名稱:拿鐵\n餐點價格:60元");
                        num=0;
                        tv_num.setText(" "+num);
                        image=3;
                        break;
